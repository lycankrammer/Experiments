...
(define-constant +hours/week+ (* +days/week+ +hours/day+))
(define-constant +minutes/week+ (* +hours/week+ +minutes/hour+))
(define-constant +seconds/week+ (* +minutes/week+ +seconds/minute+))
...
(define-constant +month-names+ '("January" "February" "March" "April" "May" "June"
                                 "July" "August" "September" "October" "November" "December")
  :test #'equal)

(define-constant +month-names-short+ '("Jan" "Feb" "Mar" "Apr" "May" "Jun" "Jul" "Aug" "Sep" "Oct" "Nov" "Dec")
  :test #'equal)
